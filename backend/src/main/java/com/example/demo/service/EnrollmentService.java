...
public interface EnrollmentService {
    ...
    List<EnrollmentResponse> findByClass(Integer classId, Integer currentUserId);

    /** Tất cả lớp của một student (admin/teacher view) */
    List<EnrollmentResponse> findByStudent(Integer studentId, Integer currentUserId);
     ...
     */
    EnrollmentResponse enroll(Integer classId, EnrollmentRequest request, Integer currentUserId);

    List<BulkEnrollmentItemResponse> enrollBulk(Integer classId, List<Integer> studentIds,
                                                Integer currentUserId);

    /** ENRL-04: Cập nhật trạng thái enrollment */
    EnrollmentResponse updateStatus(Integer classId, Integer studentId,
     ...
     */
    void cancel(Integer classId, Integer studentId, Integer currentUserId);
